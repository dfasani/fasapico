...
moteur_a = Moteur(broche_in1=11, broche_in2=12, broche_pwm=13, vitesse=65535)
moteur_b = Moteur(broche_in1=9, broche_in2=10, broche_pwm=8, vitesse=65535)
...
#on diminue les gaz
moteur_a.definir_vitesse(25000)
moteur_b.definir_vitesse(25000)
#TODO ajouter les autres moteurs
